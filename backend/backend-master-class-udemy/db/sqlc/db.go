...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.listAсcountsStmt, err = db.PrepareContext(ctx, listAсcounts); err != nil {
		return nil, fmt.Errorf("error preparing query ListAсcounts: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.listAсcountsStmt != nil {
		if cerr := q.listAсcountsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listAсcountsStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		listAсcountsStmt:        q.listAсcountsStmt,
