...
// ListAсcounts mocks base method.
func (m *MockStore) ListAсcounts(arg0 context.Context, arg1 db.ListAсcountsParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAсcounts", arg0, arg1)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAсcounts indicates an expected call of ListAсcounts.
func (mr *MockStoreMockRecorder) ListAсcounts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAсcounts", reflect.TypeOf((*MockStore)(nil).ListAсcounts), arg0, arg1)
}
